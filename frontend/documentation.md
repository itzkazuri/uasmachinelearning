...
2.  **Menjalankan Mode Pengembangan**:
    ...
    ```
3.  **Metode Deteksi**:
    - **Unggah Gambar**: Menggunakan HTTP POST ke `/predict`.
    - **Kamera Real-time**: Menggunakan **WebSocket** ke `/ws/predict` untuk stream gambar secara langsung dan mendapatkan hasil klasifikasi instan.
